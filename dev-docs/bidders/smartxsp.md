...
| `language`    | optional | Two letter language code | `'fr'` | `string` |

### Note

The Smartico bidder adaptor requires setup and approval from the SmartXSP team. Please reach out to [hello@smartxsp.io](mailto:hello@smartxsp.io) for more information.<br>
<br>
...
• Parameter <b>'language'</b> is used as creatives feed filter, making sure creatives of specified or no language content to be only provided and simultaneously making sure labels of specified language to be displayed inside creatives. The default label language is English.     
